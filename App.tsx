...
import type { FinancialData, ChartData, CalculationResult, ChatMessage } from './types';
import { getAiStream } from './geminiService';
...
const App: FC = () => {
  ...
  const handleInputChange = useCallback((e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (keys.length === 2) {
      const [category, field] = keys as [keyof typeof inputs, string];
      setInputs(prev => ({
        ...prev,
